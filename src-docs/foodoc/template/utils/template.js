...
var kinds = exports.kinds = {
	custom: ['readme', 'global', 'source', 'tutorial', 'list','disco'],
	pages: ['readme', 'global', 'source', 'tutorial', 'list', 'disco', 'class', 'external', 'mixin', 'module', 'namespace', 'interface'],
	symbols: ['tutorial','disco','class', 'external', 'event', 'mixin', 'module', 'namespace', 'interface', 'member', 'function', 'constant', 'typedef'],
...
if (!options.navMembers.length){
	options.navMembers = [
	{"kind": "disco", "title": "Discord", "summary": "All documented Discord."},
